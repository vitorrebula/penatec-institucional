...
export default function CTASection() {
  ...
  return (
    <section id="cta-section" style={{ backgroundColor: '#FFCB08', padding: '100px 0', position: 'relative', overflow: 'hidden' }}>
      ...
      <style>{`
        @media (max-width: 600px) {
          ...
          #cta-section > div:last-child { padding: 0 24px !important; }
          .cta-buttons { flex-direction: column !important; align-items: stretch !important; }
          .cta-buttons > div { width: 100% !important; }
