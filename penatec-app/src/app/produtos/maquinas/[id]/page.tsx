          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', position: 'relative' }} className="maquina-hero-inner">
            ...
            <motion.div variants={staggerContainer} initial="hidden" animate="visible">
              ...
              <motion.p variants={fadeUp} style={{
                ...
                color: 'rgba(255,255,255,0.5)', maxWidth: 460, marginBottom: machine.price != null ? 24 : 40,
              }}>
                {machine.description}
              </motion.p>
              ...
              {machine.price != null && (
                <motion.div variants={fadeUp} style={{ marginBottom: 40 }}>
                  <span style={{
                    ...
                    {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(machine.price)}
                  </span>
                  <span style={{
                    display: 'block',
